...
function SubSectionModal({
    ...
    const handleEditSubSection = async() => {
        ...
        if(currValues.lectureTitle !== modalData.lectureTitle){
            formData.append("title", currValues.lectureTitle);
        }
        if(currValues.lectureDesc !== modalData.lectureDescription){
            formData.append("description",currValues.lectureDesc);
        }
        if(currValues.lectureVideo !== modalData.lectureVideoUrl){
            formData.append("lectureVideo",currValues.lectureVideo);
        }
