  ...
  return (
    <div className=''>
        ...
        <div className='relative mx-auto flex  flex-col w-11/12 items-center max-w-maxContent text-white justify-between'>
            ...
            {/* Handle Issue Button  */}
            <button className='text-white fixed top-20 right-5 bg-richblack-700 py-1 px-3 rounded-xl z-100'>
              🤔 Facing An Issue
            </button>
            ...
            <div className='text-center font-semibold text-4xl mt-7 mx-auto'>
                Empower Your Future With
                <HightlightText text={"Coding Skills"} />
            </div>

            <div className='mt-4 mx-auto w-[78%] text-lg text-center font-bold text-richblack-300'>
            ...
            {/* video  */}
            <div className="mx-3 my-12 shadow-[10px_-5px_50px_-5px] shadow-blue-200 z-10">
                <video
                className="shadow-[20px_20px_rgba(255,255,255)] z-10"
                muted
                loop
                autoPlay
                >
